...
<template>
  <div class="login-wrapper">
    <div class="auth-container" :class="{ active: isSignUp }" id="container">
      ...
      <div class="toggle-container">
        <div class="toggle">
          <div class="toggle-panel toggle-left">
            ...
            <button class="hidden" id="login" @click="isSignUp = false">Sign In</button>
          </div>
          <div class="toggle-panel toggle-right">
            <h1>Hello, Friend!</h1>
            <p>Register with your personal details to use all of site features</p>
            <button class="hidden" id="register" @click="isSignUp = true">Sign Up</button>
          </div>
        </div>
      </div>
    </div>
